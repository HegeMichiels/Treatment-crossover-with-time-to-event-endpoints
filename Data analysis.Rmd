...
source("~/OneDrive - UGent/Crossover/R-code/Functions.R") #Import the "Functions.R" file #VERANDEREN NAAR ONLINE LINK
data <- read.delim("~/OneDrive - UGent/Crossover/R-code/data.txt") #Import dataset #VERANDEREN NAAR ONLINE LINK
